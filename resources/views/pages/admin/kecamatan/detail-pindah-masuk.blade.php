...
@section('content')
    <div
        ...
        <div class="container p-10 mx-auto">
            <h2 class="mb-6 text-3xl font-bold text-red-800">Detail Pengajuan Surat Pindah Masuk</h2>

            <hr class="mb-4 bg-red-600 h-0.5">

            <form action="{{ route('kecamatan.submitPindahMasuk', $dataDiri->id) }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <textarea class="w-full px-4 py-2 border border-gray-200 rounded-lg md:w-3/4" rows="5" name="catatan"
