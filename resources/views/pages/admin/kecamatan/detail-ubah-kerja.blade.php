...
@section('content')
    <div
        ...
        <div class="container p-10 mx-auto">
            ...
            <form action="{{ route('kecamatan.submitUbahKerja', $dataDiri->id) }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <textarea id="catatan" class="w-full px-4 py-2 border border-gray-200 rounded-lg md:w-3/4" rows="5"
                        placeholder="Catatan" name="catatan"></textarea>
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <input type="text" id="jenis_kelamin"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" readonly
                        value="{{ $dataDiri->jenisKelamin == 0 ? 'Laki-laki' : 'Perempuan' }}">
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <input type="text" id="tanggal_lahir"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" readonly
                        value="{{ $dataDiri->tanggalLahir->format('d F Y') }}">
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <input type="text" id="namaProvinsi"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" readonly
                        value="{{ $daerahTujuan ? $daerahTujuan->namaProvinsi : 'N/A' }}">
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <input type="text" id="namaRw"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" readonly
                        value="{{ $daerahTujuan ? $daerahTujuan->namaRw : 'N/A' }}">
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <input type="text" id="namaRt"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" readonly
                        value="{{ $daerahTujuan ? $daerahTujuan->namaRt : 'N/A' }}">
                </div>
                ...
                <div class="flex flex-col items-center mb-4 md:flex-row">
                    ...
                    <select id="nama_status" class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4" disabled>
                        <option value="Belum Kerja"
                            {{ $statusPekerjaan->nama_status == 'Belum Kerja' ? 'selected' : '' }}>
