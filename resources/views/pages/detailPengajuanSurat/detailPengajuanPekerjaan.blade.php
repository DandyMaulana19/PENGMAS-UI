        ...
        <div class="container p-10 mx-auto">
            ...
            <div class="flex flex-col items-center mb-4 md:flex-row">
                ...
                <textarea id="catatan" class="w-full px-4 py-2 border border-gray-200 rounded-lg md:w-3/4" rows="5"
                    placeholder="Catatan" readonly>{{ $catatan }}</textarea>
            </div>
            ...
            <div class="flex flex-col items-center mb-4 md:flex-row">
                ...
                <input type="text" id="namaKabupaten" class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4"
                    readonly value="{{ $daerahTujuan ? $daerahTujuan->namaKabupaten : 'N/A' }}">
            </div>

            <div class="flex flex-col items-center mb-4 md:flex-row">
                <label for="namaKecamatan" class="w-full md:w-1/4">Kecamatan</label>
                <input type="text" id="namaKecamatan" class="w-full px-4 py-2 border border-gray-300 rounded-lg md:w-3/4"
                    readonly value="{{ $daerahTujuan ? $daerahTujuan->namaKecamatan : 'N/A' }}">
            </div>
