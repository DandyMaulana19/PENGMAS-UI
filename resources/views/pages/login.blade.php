...
@section('content')
    <div class="relative container flex min-h-screen justify-center items-center">
        <div
            class="flex flex-col w-11/12 md:w-4/12 items-center text-center bg-[#F9F9F9] border border-gray-200 shadow-md rounded-xl p-10">
            <img src="{{ asset('assets/Logo Desa.svg') }}" width="200" alt="">
