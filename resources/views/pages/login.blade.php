        ...
        <div
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mt-6 mb-10 w-full text-start">
                    <label for="username" class="block text-sm font-medium mb-2 text-black">Username</label>
                    ...
                    <label for="password" class="block text-sm font-medium mb-2 text-black">Password</label>
