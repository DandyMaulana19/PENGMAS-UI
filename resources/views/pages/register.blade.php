...
@section('content')
    <div class="container flex min-h-screen justify-center items-center py-8">
        <div
            ...
            <img src="{{ asset('assets/Logo Desa.svg') }}" width="200" class="mb-4" alt="">
            ...
            <form action="{{ url('/register') }}" method="POST" class="w-full mt-6">
                @csrf
            ...
            <span class="text-sm text-center mt-6 block">Sudah punya akun?
                <a href="{{ url('/login') }}" class="text-[#9B1010]">Masuk.</a>
            </span>
        </div>
    </div>
@endsection
