...
@section('content')
    <div class="container py-12">
        <div class="w-full p-6 bg-white rounded-xl shadow-md">
            <h1 class="font-bold text-2xl mb-6">Pengajuan Ubah Status Pekerjaan</h1>
                        ...
                        <div class="border overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @foreach ($dataDiri as $index => $item)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-xs text-black">{{ $index + 1 }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-xs text-black">
                                                {{ $item->tempatLahir }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-xs text-black">
                                                {{ \Carbon\Carbon::parse($item->tanggalLahir)->format('d F Y') }}</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-xs text-white">
                                                <a href="{{ url('/warga/form-pekerjaan/' . $item->id) }}"
